...
<div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8 h-[calc(100vh-140px)] flex flex-col">
    ...
    <div class="flex-grow flex flex-col bg-white shadow-xl rounded-lg overflow-hidden border border-gray-200">
        <div id="chatContainer" class="flex-grow p-4 sm:p-6 overflow-y-auto space-y-4 bg-gray-50">
            <!-- Welcome Message -->
            <div class="flex items-start">
                <div class="flex-shrink-0 h-10 w-10 rounded-full bg-primary flex items-center justify-center text-white font-bold">
                    AI
                </div>
                <div class="ml-3 bg-white p-3 rounded-lg shadow-sm border border-gray-200 max-w-[85%] sm:max-w-[75%]">
        ...
        <div class="p-4 bg-white border-t border-gray-200">
            <form id="chatForm" class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                ...
                <button type="submit" id="sendBtn" class="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
